...
> Planning draft. Some sections describe proposed models or earlier analysis
> choices. The implemented transcriptomic/network workflow is documented in
> [the current workflow guide](../workflow.md); use that guide
> for dataset, scoring, and validation claims.
> The older studies described below are historical: their data files and
> supplementary results have been removed. GSE220559 is the current benchmark.
